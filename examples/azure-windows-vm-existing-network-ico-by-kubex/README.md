...
Intel Cloud Optimizer by Kubex helps customers optimize their cloud investments and ensure optimal performance for every workload.

Intel Cloud Optimizer by Kubex is a commercial product. With Intel® Cloud Optimizer, Intel funds the use of Kubex for qualifying enterprises for 12 months. For full details of the Intel Cloud Optimizer by Kubex offer please see: [INTEL CLOUD OPTIMIZER by Kubex](https://kubex.ai/product/intel/)

Using this example requires a "kubex_recommndations.auto.tfvars" file. You are expected to generate this file so this is a sample file only. 
