...
# Currently, D/Ev7 with recommended Intel GNR is only aviable on Central US region. Check availablity for other regions here: https://azure.microsoft.com/en-us/pricing/details/virtual-machines/series/ and filter by "6th Gen Intel Xeon Scalable processors (Granite Rapids)"
...
variable "source_image_reference_sku" {
  ...
  type        = string
  default     = "2022-Datacenter-g2" # Generation 2 SKU required by EMR v6 Insances
}
